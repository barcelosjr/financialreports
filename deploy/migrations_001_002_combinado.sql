-- Combina migrations/001_init.sql + 002_estrutura_contas.sql num arquivo só,
-- pra colar de uma vez na aba "SQL" do phpMyAdmin (Fase 0+1). Gerado a partir
-- de portal-backend-php/migrations/ -- se essas migrations mudarem, gere de
-- novo (ou rode os dois arquivos separados, na ordem 001 depois 002).
